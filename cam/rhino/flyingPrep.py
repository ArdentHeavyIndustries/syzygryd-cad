...
def labelObject(color, cubeNumber):
...
if( __name__ == '__main__' ):
    ...
    cubeNumber=rs.GetInteger("Cube number")

    labelObject("B", cubeNumber)
    labelObject("G", cubeNumber)
    labelObject("C", cubeNumber)
    labelObject("Y", cubeNumber)
    labelObject("R", cubeNumber)
    labelObject("O", cubeNumber)
